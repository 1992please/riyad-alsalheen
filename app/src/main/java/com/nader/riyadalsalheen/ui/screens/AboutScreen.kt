    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                AboutSection(
                    title = "عن الكتاب",
                    content = "رياض الصالحين من كلام سيد المرسلين هو كتاب حديث نبوي من تأليف الإمام النووي، " +
                            "جمع فيه الأحاديث الصحيحة المتعلقة بأمور الآخرة وأعمال القلوب والجوارح والأخلاق والآداب " +
                            "والتربية الإسلامية. يعد هذا الكتاب من أشهر كتب الحديث وأكثرها انتشاراً وقراءة في العالم الإسلامي."
                )
            }
